...
**1. Welche Sondervariable legt die Zahl der Flächen eines runden Objekts unmittelbar fest?**

{r1{das Dollarzeichen mit t}}

{r1{!das Dollarzeichen mit fn}}

{r1{das Dollarzeichen mit pi}}

{r1{es gibt keine solche Variable}}

{h{Sie steht für die Anzahl der Fragmente.}}
{H{Richtig. Daneben gibt es fa für den kleinsten Winkel und fs für die kleinste Kantenlänge – die wirken nur, solange fn nicht gesetzt ist.}}

**2. Du setzt die Winkelvariable fa auf 1. Was passiert?**

{r2{Die Oberfläche wird sehr eckig.}}

{r2{!Die Oberfläche wird sehr glatt – und die Vorschau spürbar langsamer.}}

{r2{Die Farbe ändert sich.}}

{r2{Nichts.}}

{h{Ein kleinerer Winkel je Fläche bedeutet mehr Flächen.}}
{H{Richtig. Deshalb setzt man hohe Auflösungen erst ganz am Ende.}}

**3. Wozu dient die Sondervariable t?**

{r3{Sie legt die Temperatur beim Drucken fest.}}

{r3{!Sie läuft bei einer Animation von 0 bis 1 und lässt sich zum Bewegen von Objekten benutzen.}}

{r3{Sie gibt die Zahl der Flächen an.}}

{r3{Sie bestimmt die Textgröße.}}

{h{Der Buchstabe steht für time.}}
{H{Richtig – für den Druck spielt sie keine Rolle, zum Zeigen von Bewegungen aber schon.}}

**4. Warum lohnt es sich, Maße voneinander abzuleiten statt jedes einzeln festzulegen?**

{r4{Weil OpenSCAD sonst rundet.}}

{r4{!Weil dann beim Ändern eines Grundmaßes alles Abhängige stimmig mitwächst.}}

{r4{Weil abgeleitete Maße schneller berechnet werden.}}

{r4{Das lohnt sich nicht.}}

{h{Was passiert, wenn die Wandstärke fest eingetragen ist und der Durchmesser sich verdoppelt?}}
{H{Richtig.}}
