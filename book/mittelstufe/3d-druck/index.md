...
| --- | --- |
| [1 Erste Schritte](./01-erste-schritte) | Was 3D-Druck ist, und dein erstes eigenes Modell |
| [2 Körper und Koordinaten](./02-koerper-und-koordinaten) | Wo im Raum ein Objekt steht und woraus es besteht |
| [3 Transformationen](./03-transformationen) | Objekte verschieben, drehen und miteinander verrechnen |
| [4 Parameter und Wiederholung](./04-parameter-und-wiederholung) | Aus einem Modell wird ein Programm: Variablen, Schleifen, eigene Bausteine |
| [5 Gestalten](./05-gestalten) | Farben, Text und Bilder im Modell |
| [6 Bibliotheken](./06-bibliotheken) | Fremden Code benutzen, statt alles selbst zu schreiben |
| [7 Slicing](./07-slicing) | Vom Modell zu den Anweisungen für den Drucker |
| [8 Drucken](./08-drucken) | Wie der Drucker arbeitet und was im G-Code steht |
| [9 Projekt](./09-projekt) | Übungen und ein eigenes Abschlussprojekt |
| [10 Referenz](./10-referenz) | Spickzettel und die häufigsten Fehler |
