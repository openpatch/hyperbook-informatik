...
{r1{eine Schraube im Modell}}

{r1{!ein benannter Punkt an einem Objekt, etwa seine Oberseite oder eine Kante}}

{r1{der Nullpunkt des Koordinatensystems}}

{r1{eine Farbe}}

{h{Damit kann man sagen wohin, ohne Koordinaten auszurechnen.}}
{H{Richtig.}}

**2. Welchen Vorteil hat das Positionieren über Anker gegenüber translate?**

{r2{Es ist kürzer zu tippen.}}

{r2{!Ändert sich die Größe des Objekts, stimmt die Position weiterhin – ohne dass man nachrechnen muss.}}

{r2{Es funktioniert auch ohne Bibliothek.}}

{r2{Es ist genauer.}}

{h{Was passiert bei translate mit halber Höhe, wenn die Höhe sich ändert?}}
{H{Richtig – das ist derselbe Gedanke wie bei Parametern statt fester Zahlen.}}

**3. Wozu dient das anchor-Attribut an einem Objekt?**

{r3{Es verschiebt das Objekt an den Nullpunkt.}}

{r3{!Es legt fest, welcher Punkt des Objekts als sein Bezugspunkt gilt.}}

{r3{Es dreht das Objekt.}}

{r3{Es rundet die Kanten ab.}}

{h{Standardmäßig ist das die Mitte – man kann aber auch eine Ecke wählen.}}
{H{Richtig.}}
