...
2. Setze die Schritte im Objektdiagramm unten um.

::jmp{id="verzoegerte-ankunft" src="verzoegerte-ankunft.jmp" height="760px"}
...
1. Die Nachricht von frida soll gelöscht werden. Erprobe am Objektdiagramm unten verschiedene
   Möglichkeiten, das umzusetzen – dieses Diagramm hat absichtlich keine Musterlösung, weil es
   mehr als einen vertretbaren Weg gibt.

::jmp{id="nachricht-loeschen" src="nachricht-loeschen.jmp" height="760px"}
