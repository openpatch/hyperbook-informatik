...
Bei den Grundlagen verweise ich jeweils auf den Lernpfad [Webentwicklung](/mittelstufe/web). Dort steht ausführlich, was hier nur kurz vorkommt.
...
Du arbeitest dabei in einem **Editor mit mehreren Dateien** – so, wie es auch beruflich gemacht wird. Welchen du nimmst, steht im [Setup](./03-setup).
